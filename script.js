...
const CONTOURS = [
  { level: -1.6, color: 'rgba(100, 40, 200, 0.22)' },
  { level: -1.2, color: 'rgba(120, 50, 220, 0.20)' },
  { level: -0.8, color: 'rgba(140, 60, 230, 0.18)' },
  { level: -0.4, color: 'rgba(155, 80, 240, 0.16)' },
  { level:  0.0, color: 'rgba(160, 90, 245, 0.15)' },
  { level:  0.4, color: 'rgba(140, 70, 235, 0.14)' },
  { level:  0.8, color: 'rgba(110, 50, 215, 0.13)' },
  { level:  1.2, color: 'rgba( 80, 40, 190, 0.18)' },
  { level:  1.6, color: 'rgba( 60, 30, 160, 0.20)' },
  // Bright accent lines
  { level: -0.6, color: 'rgba(190,120,255, 0.28)' },
  { level:  0.2, color: 'rgba(160, 90,255, 0.22)' },
  { level:  0.9, color: 'rgba(120, 60,220, 0.20)' },
  { level: -1.0, color: 'rgba( 80,120,255, 0.20)' },
];
